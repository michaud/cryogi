...
const ProjectSummary = ({ item: project, selected, onSelect }) => {
    ...
    return <div className="c-project-summary" key={ project.iri } onClick={ handleOnClick }>
                ...
                <div className="actions">
                    { selected === undefined
                        ...
                        : <IconButton aria-label="edit">
                            { selected
                                ? <PlaylistAddCheckIcon fontSize="large" style={ { color: 'black' } } />
                                : <PlaylistAddIcon fontSize="large" style={ { color: 'black' } } />
                            }
                        </IconButton>
                    }
                </div>
